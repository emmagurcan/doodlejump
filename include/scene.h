...
/**
 * A collection of a list of bodies and a void *, usually a constant.
 */
typedef struct param param_t;


/**
 * Initializes the param_t.
 * @param bodies a list of bodies.
 * @param constant a void * that can be anything, usually a constant (double).
 * @param freer a freer for the void *.
 * Returns a param_t *.
 */
...
/**
 * Returns the body at a gicen index
 * @param param a param_t *.
 * @param index the index of the desired body
 * Returns the body at the desired index.
 */
 ...
 * Returns the void *.
 * @param param a param_t *.
 * Returns the variable associated with constant.
 */
