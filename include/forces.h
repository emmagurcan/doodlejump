...
/**
 * A collection of two bodies, a collision_handler_t name, an axis, and an aux
 * to put in the handler.
 *
 */
typedef struct col_aux col_aux_t;

/**
 * A freer for the col_aux collection.
 */
